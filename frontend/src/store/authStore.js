...
export const authStore = create((Set,get) => ({
    ...
    adminLogin: async (email, password) => {
        ...
        const { data } = await axios.post(ADMIN_BASE_URL + '/login', { email , password });
    ...
    login: async (email, password) => {
        ...
        const { data } = await axios.post(AUTH_BASE_URL + '/login', { email , password });
    ...
    checkAuth: async () => {
        ...
        try {
            ...
            const { data } = await axios.post(AUTH_BASE_URL + '/checkAuth',  { token } );
